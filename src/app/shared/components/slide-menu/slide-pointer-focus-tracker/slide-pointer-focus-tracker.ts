// https://github.com/angular/components/blob/main/src/cdk/menu/pointer-focus-tracker.ts
/**
 * @license
...
import { map, mergeAll, mergeMap, startWith, takeUntil } from 'rxjs/operators';

/**
 * PointerFocusTracker keeps track of the currently active item under mouse focus. It also has
 * observables which emit when the users mouse enters and leaves a tracked element.
 */
export class SlidePointerFocusTracker<T extends FocusableElement> {
